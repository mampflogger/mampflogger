...
const FOOD_CATEGORY_MAP: Record<string, FoodCategory> = {
  ...
  "Hähnchenflügel": "Fleisch&Wurst", "Hähnchenkeule (mit Haut)": "Fleisch&Wurst",
  ...
  "Lammfilet": "Fleisch&Wurst", "Lammhaxe": "Fleisch&Wurst", "Lammkeule": "Fleisch&Wurst",
  "Lammkotelett": "Fleisch&Wurst", "Lammrücken": "Fleisch&Wurst", "Lammschulter": "Fleisch&Wurst",
  ...
  "Rehkeule": "Fleisch&Wurst", "Rinderbraten": "Fleisch&Wurst", "Rinderbrust (Tafelspitz)": "Fleisch&Wurst",
  ...
  "Rinderschnitzel": "Fleisch&Wurst", "Roastbeef": "Fleisch&Wurst", "Romanasalat": "Gemüse",
  ...
  "Süßkartoffel": "Gemüse", "Süßkirschen": "Obst", "Tafelspitz (Rind)": "Fleisch&Wurst",
...
export function guessCategory(name: string, aiCategory?: string): FoodCategory {
  ...
  const keywords: [string[], FoodCategory][] = [
    [["huhn", "hähn", "pute", "rind", "schwein", "lamm", "ente", "gans", "kalb", "wurst", "schinken", "speck", "hack", "filet", "steak", "braten", "gulasch", "schnitzel", "salami", "fleisch", "bacon", "reh", "hirsch", "wildschwein", "haxe", "keule", "roulade", "suppenhuhn"], "Fleisch&Wurst"],
...
export const DEFAULT_FOODS: FoodItem[] = [
  ...
  { name: "Bratwurst (fein)", baseUnit: "100g", baseAmount: 100, calories: 312, protein: 13.5, fat: 28.5, carbs: 0.5, fiber: 0, defaultAmount: 100 },
  ...
  { name: "Tafelspitz (Rind)", baseUnit: "100g", baseAmount: 100, calories: 174, protein: 21.4, fat: 9.8, carbs: 0, fiber: 0, defaultAmount: 150 },
