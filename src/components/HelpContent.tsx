...
const FAQ_ITEMS: FaqItem[] = [
  ...
  { question: "Wie erstelle ich ein Backup meiner Daten und wie kann ich es wieder einlesen?", answer: "Gehe in die Einstellungen unter 'Daten'. Dort findest du die Funktion 'Sichern', die alle deine Daten (Profil, Einträge, Lebensmittel, Rezepte und Aktivitäten) als Datei exportiert. Mit 'Laden' kannst du eine zuvor erstellte Sicherungskopie wieder einlesen – alle Daten werden dabei vollständig wiederhergestellt. Per Sprache: Sage 'Backup' um den Kasten zu fokussieren, dann 'Sichern' oder 'Laden'." },
