...
const HELP_TOPICS: Record<HelpTab, HelpTopic[]> = {
  eingabe: [
    ...
    { label: "Tagesprotokoll", description: "Listet alle Lebensmittel auf, die du heute eingetragen hast – inklusive Kalorien und Makronährstoffe. Du kannst Einträge bearbeiten oder löschen und siehst die Gesamtsumme unten." },
    ...
    { label: "Gewicht", description: "Trage dein aktuell gemessenes Gewicht in kg ein und bestätige mit OK. Darunter siehst du das rechnerische Gewicht (basierend auf deinem Kaloriendefizit), das aktuelle Gewicht und die Abweichung. Der Fortschrittsbalken zeigt, wie viel Prozent du auf dem Weg vom Startgewicht (Profil) zum Zielgewicht geschafft hast. Beim Aktivieren des Kastens per Sprachbefehl springt der Cursor direkt ins Eingabefeld." },
    { label: "BMI", description: "Zeigt deinen aktuellen Body-Mass-Index. Berechnet aus dem letzten gemessenen Gewicht (oder dem Profilgewicht, falls keines vorhanden) und deiner Größe. Der Fortschrittsbalken läuft vom Start-BMI (aus deinem Profilgewicht) zum Ziel-BMI (aus deinem Zielgewicht)." },
  ],
  statistik: [
    { label: "Übersicht", description: "Zeigt dir die wichtigsten Kennzahlen der letzten 7 Tage auf einen Blick: Durchschnittsdefizit, durchschnittliche Kalorienaufnahme und wie viele Tage du noch bis zu deinem Zielgewicht brauchst. Die Berechnung des Zielgewichts und des Grundumsatzes basiert auf deinem zuletzt gemessenen Gewicht (sonst auf dem Profilgewicht)." },
    { label: "Gewichtsverlauf", description: "Liniendiagramm aller gebuchten Wiegungen über die Zeit. Die durchgezogene Linie sind deine tatsächlich gemessenen Werte, die gestrichelte graue Linie das rechnerische Gewicht aus dem Kaloriendefizit. Die rote gestrichelte Linie markiert dein Zielgewicht. Die X-Achse skaliert proportional zur Zeit zwischen den Wiegungen." },
    ...
    { label: "Gewichtsverlust pro Tag", description: "Rechnet dein tägliches Defizit in geschätzten Körperfett-Verlust in Gramm um (≈7700 kcal pro kg). Grüne Balken = Verlust, rote Balken = Zunahme durch Überschuss." },
    { label: "Makroverlauf", description: "Liniendiagramm der vier Makrobausteine Protein, Fett, Kohlenhydrate und Ballaststoffe in Gramm pro Tag. Y-Achse einheitlich von 0 bis 300 g. Über die Buttons unter dem Chart kannst du einzelne Makros ein-/ausblenden (PRO, FAT, KH, FIB), den Zeitraum wählen (30T/60T/90T/180T) und mit dem ∅-Button einen gleitenden Durchschnitt (7–21 Tage je nach Zeitraum) einschalten, der Tagesausschläge glättet und langfristige Trends sichtbar macht. Die rechte X-Achsen-Beschriftung zeigt das Datum des letzten abgeschlossenen Tages." },
    { label: "Makros pro Tag", description: "Interaktive Karte mit Wochentag-Buttons, über die du für jeden der letzten 7 Tage die Verteilung von Eiweiß, Fett, Kohlenhydraten und Ballaststoffen in Gramm als horizontale Balken anzeigen kannst." },
  ...
  sprache: [
    { label: "Mikrofon aktivieren", description: "Tippe auf das Mikrofon-Symbol im Header, um die Sprachsteuerung zu starten. Wenn ein farbiger Kreis um das Mikrofon pulsiert, hört die App zu. Nochmal tippen schaltet es wieder aus." },
    ...
    { label: "Weitere Sprachbefehle", description: "Neben der Lebensmitteleingabe unterstützt die App viele allgemeine Befehle: 'Nach unten' / 'Nach oben' scrollt die Seite, 'Ganz nach oben' / 'Ganz nach unten' springt ans Ende. 'Zurück' navigiert zum vorherigen Schritt oder schließt ein offenes Menü. 'Löschen' oder 'Storno' setzt die aktuelle Eingabe zurück. 'OK' oder 'Ja' bestätigt eine Aktion. 'Home' oder 'Start' bringt dich jederzeit zurück zur Hauptansicht. Du kannst außerdem Aktivitäten diktieren ('30 Minuten Joggen'), Einträge löschen ('lösche den letzten Eintrag') oder nach Informationen fragen ('wie viel Kalorien habe ich heute?')." },
  ],
  einstellungen: [
...
const FAQ_ITEMS: FaqItem[] = [
  ...
  { question: "Kann ich die App für eine Keto-Ernährung nutzen?", answer: "Ja! Die Makro-Verteilung zeigt dir genau, wie viel Eiweiß, Fett, Kohlenhydrate und Ballaststoffe du zu dir nimmst – perfekt für Keto. Im Tagesprotokoll und der Statistik siehst du sofort, ob du im gewünschten Verhältnis liegst. Auch der KI-Coach analysiert deine Ernährung der letzten 7 Tage und gibt dir personalisierte Tipps passend zu deiner Ernährungsform." },
  ...
  { question: "Wie erstelle ich ein Backup meiner Daten und wie kann ich es wieder einlesen?", answer: "Gehe in die Einstellungen unter 'Daten'. Dort findest du die Kachel 'Sicherung' mit der Funktion 'Sichern', die alle deine Daten (Profil, Einträge, Lebensmittel, Rezepte und Aktivitäten) als Datei exportiert. Mit 'Laden' kannst du eine zuvor erstellte Sicherungskopie wieder einlesen – alle Daten werden dabei vollständig wiederhergestellt. Per Sprache: Sage 'Backup' oder 'Sicherungskopie' – dann wird sofort und aus jedem Bereich heraus (auch aus der Eingabemaske) eine Sicherungsdatei erstellt. Sage 'Sicherung', wenn du stattdessen nur die Kachel fokussieren willst, um dort 'Sichern' oder 'Laden' zu nutzen." },
