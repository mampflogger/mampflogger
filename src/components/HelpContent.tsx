...
const HELP_TOPICS: Record<HelpTab, HelpTopic[]> = {
  ...
  statistik: [
    ...
    { label: "Makroverlauf", description: "Liniendiagramm über die letzten 90 Tage mit den vier Makrobausteinen Protein, Fett, Kohlenhydrate und Ballaststoffe in Gramm pro Tag. Y-Achse von 0 bis 250 g. Protein in der kräftigen Hauptfarbe, Fett mittel, Kohlenhydrate hell, Ballaststoffe als gestrichelte graue Linie. Zeigt Gleichmäßigkeit der Versorgung und Spitzen einzelner Makros." },
