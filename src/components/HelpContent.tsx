...
const HELP_TOPICS: Record<HelpTab, HelpTopic[]> = {
  ...
  statistik: [
    ...
    { label: "Makroverlauf", description: "Liniendiagramm der vier Makrobausteine Protein, Fett, Kohlenhydrate und Ballaststoffe in Gramm pro Tag. Y-Achse einheitlich von 0 bis 250 g. Über die Buttons unter dem Chart kannst du einzelne Makros ein-/ausblenden (PRO, FAT, KH, FIB), den Zeitraum wählen (30T/60T/90T/180T) und mit dem ∅-Button einen gleitenden Durchschnitt (7–21 Tage je nach Zeitraum) einschalten, der Tagesausschläge glättet und langfristige Trends sichtbar macht. Die rechte X-Achsen-Beschriftung zeigt das Datum des letzten abgeschlossenen Tages." },
