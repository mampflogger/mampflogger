...
const DEFAULT_HELP_TEXTS: Record<string, string> = {
  ...
  "section-bmi": `Im BMI-Kasten siehst du deinen aktuellen Body-Mass-Index, berechnet aus deinem letzten gemessenen Gewicht oder – falls noch keines eingetragen ist – aus dem Gewicht in deinem Profil. Der Fortschrittsbalken zeigt dir, wie weit du auf dem Weg vom Start-BMI deines Profils zum Ziel-BMI gekommen bist, das sich aus deinem Zielgewicht ergibt. Hundert Prozent bedeutet, du hast deinen Ziel-BMI erreicht.`,

  "section-gewichts-verlauf": `Der Gewichtsverlauf zeigt dir alle deine gebuchten Wiegungen im zeitlichen Verlauf als Liniendiagramm. Auf der X-Achse siehst du die Tage seit der ersten Wiegung, auf der Y-Achse das Gewicht in Kilogramm. Die durchgezogene Linie in der Hauptfarbe sind deine tatsächlich gemessenen Werte, die gestrichelte graue Linie zeigt das rechnerische Gewicht, das aus deinem Kaloriendefizit ermittelt wurde. Eine rote gestrichelte Linie markiert dein Zielgewicht.`,
  ...
  "section-makro-verlauf": `Der Makroverlauf zeigt dir die Entwicklung deiner vier Makrobausteine Protein, Fett, Kohlenhydrate und Ballaststoffe als Liniendiagramm. Jede Linie steht für einen Makronährstoff in Gramm pro Tag. Protein ist in der kräftigen Hauptfarbe, Fett mittel, Kohlenhydrate hell, und Ballaststoffe als gestrichelte graue Linie. Die Y-Achse reicht einheitlich von null bis zweihundertfünfzig Gramm. Über die Buttons unterhalb des Diagramms kannst du die Makros einzeln ein- und ausblenden und den Zeitraum zwischen dreißig, sechzig, neunzig und hundertachtzig Tagen umschalten. Mit dem Durchschnittssymbol aktivierst du einen gleitenden Durchschnitt über sieben bis einundzwanzig Tage, der die Tagesausschläge glättet und langfristige Trends sichtbar macht. Die rechte Beschriftung der X-Achse zeigt das Datum des letzten abgeschlossenen Tages.`,
